...
[expliquer avant que le csp est appliqué pour différentes bins et que l'on compare par la suite le reoc auc score pour différentess bins, ce qui permet de mettre les régions d'interet en ]
...
- Une AUC de 0.6 n'est pas elevé dans l'absolu mais pas mal en neuroscience sur des intervalles de 0.5. Si l'on combine toutes les bins on obteindrait une bien meuilleure AUC.
...
\begin{figure}[ht]
    ...
    {Resulats du contraste dans l'espace des sources pour 0s-1s, et 8Hz-14Hz.}
    \label{results_source_space}
\end{figure}
