...
\paragraph{details permutations}
...
\paragraph{CSP : Variance vs Second order moment}
...
\subparagraph{Annexes - subtilités mathématiques -philosophie de pourquoi c'est ok de réduire un peu les performances}

1. Pourquoi ne pas se battre pour les performances avec les csp.
...
2. Possiblité de mettre un des frequences et des crop non uniformes
