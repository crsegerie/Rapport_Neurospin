...
\begin{itemize}
    ...
    \item Mots-clés caractérisant votre rapport (4 à 5 mots maximum) : Mémoire de travail, apprentissage statistique, magnétoencéphalographie, analyse temps-fréquence, signaux multivariés.
\end{itemize}
